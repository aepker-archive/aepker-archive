...
export interface Trip {
  ...
  title: string;
  /**
   * URL-Teil, z. B. "stille-kuesten-schottland" (deutsch) / "quiet-coasts-scotland" (englisch)
   */
  slug: string;
  region?: ('nord' | 'sued' | 'fern') | null;
  /**
   * Kurzbeschreibung fuer Listen und Meta-Description (max. ~155 Zeichen)
   */
  excerpt?: string | null;
